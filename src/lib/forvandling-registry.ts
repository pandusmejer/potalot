...
export const FORVANDLING_ASSETS: SpisekammerAsset[] = [
  ...
  // Forvandlinger-batch 7/8 2026 (højformat 3:4). Copy-batch 2 skrev de 10
  // kuraterede katalogposter → resultatfotos bundet pr. forvandlingId.
  // Stegte/fritter/kogte/proces-kartofler = bevidst generiske (ingen egen
  // post — kataloget er ikke en takeaway-menu); kamille-bryg → kamille-te.
  { crop: 'kartoffel', cropLabel: 'Hasselback-kartofler', path: '/assets/forvandlinger/crops/kartoffel/kartoffel-hasselback-01.jpg', role: 'kitchen', mood: 'warm', useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'hasselback-kartofler', priority: 88 },
  { crop: 'kartoffel', cropLabel: 'Kartoffelmos', path: '/assets/forvandlinger/crops/kartoffel/kartoffel-mos-01.jpg', role: 'kitchen', mood: 'warm', useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'kartoffelmos', priority: 87 },
  { crop: 'kartoffel', cropLabel: 'Kartoffelsuppe', path: '/assets/forvandlinger/crops/kartoffel/kartoffel-suppe-01.jpg', role: 'kitchen', mood: 'warm', useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'kartoffelsuppe', priority: 86 },
  { crop: 'kartoffel', cropLabel: 'Hjemmelavede chips', path: '/assets/forvandlinger/crops/kartoffel/kartoffel-chips-01.jpg', role: 'kitchen', mood: 'warm', useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'hjemmelavede-chips', priority: 84 },
  ...
  { crop: 'kartoffel', cropLabel: 'Kartoffelmos med rosmarin', path: '/assets/forvandlinger/crops/kartoffel/kartoffel-mos-rosmarin-01.jpg', role: 'kitchen', mood: 'warm', useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'kartoffelmos', priority: 80 },
  ...
  { crop: 'kamille', cropLabel: 'Tørret kamille', path: '/assets/forvandlinger/crops/kamille/kamille-toerret-01.jpg', role: 'flower', mood: 'quiet', useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'toer-kamille', priority: 84 },
  { crop: 'kamille', cropLabel: 'Kamille-tebreve', path: '/assets/forvandlinger/crops/kamille/kamille-te-brev-01.jpg', role: 'kitchen', mood: 'quiet', useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'toer-kamille', priority: 82 },
  { crop: 'kamille', cropLabel: 'Kamille-tebreve', path: '/assets/forvandlinger/crops/kamille/kamille-te-brev-02.jpg', role: 'kitchen', mood: 'quiet', useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'toer-kamille', priority: 72 },
  { crop: 'kamille', cropLabel: 'Kamille undervejs', path: '/assets/forvandlinger/crops/kamille/kamille-proces-01.jpg', role: 'flower', mood: 'quiet', useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'toer-kamille', priority: 70 },
  { crop: 'fersken', cropLabel: 'Ferskner på glas', path: '/assets/forvandlinger/crops/fersken/fersken-glas-01.jpg', role: 'kitchen', mood: 'warm', seasons: ['summer'], useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'fersken-paa-glas', priority: 88 },
  { crop: 'fersken', cropLabel: 'Tørrede ferskner', path: '/assets/forvandlinger/crops/fersken/fersken-toerret-01.jpg', role: 'kitchen', mood: 'warm', useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'toerrede-ferskner', priority: 84 },
  { crop: 'fersken', cropLabel: 'Ferskner undervejs', path: '/assets/forvandlinger/crops/fersken/fersken-proces-01.jpg', role: 'kitchen', mood: 'warm', seasons: ['summer'], useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'fersken-paa-glas', priority: 78 },
  { crop: 'fersken', cropLabel: 'Ferskner undervejs', path: '/assets/forvandlinger/crops/fersken/fersken-proces-02.jpg', role: 'kitchen', mood: 'warm', seasons: ['summer'], useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'fersken-paa-glas', priority: 76 },
  { crop: 'rabarber', cropLabel: 'Rabarber undervejs', path: '/assets/forvandlinger/crops/rabarber/rabarber-proces-01.jpg', role: 'kitchen', mood: 'fresh', seasons: ['spring', 'summer'], useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'rabarberkompot', priority: 80 },
  { crop: 'hyldeblomst', cropLabel: 'Hyldeblomstsaft', path: '/assets/forvandlinger/crops/hyldeblomst/hyldeblomst-saft-01.jpg', role: 'kitchen', mood: 'summer', seasons: ['summer'], useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'hyldeblomstsaft', priority: 88 },
  { crop: 'hyldeblomst', cropLabel: 'Hyldeblomstsaft med isterninger', path: '/assets/forvandlinger/crops/hyldeblomst/hyldeblomst-saft-isterninger-01.jpg', role: 'kitchen', mood: 'fresh', seasons: ['summer'], useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'hyldeblomstsaft', priority: 84 },
  { crop: 'hyldeblomst', cropLabel: 'Hyldeblomster', path: '/assets/forvandlinger/crops/hyldeblomst/hyldeblomst-blomster-proces-01.jpg', role: 'flower', mood: 'fresh', seasons: ['summer'], useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'hyldeblomstsaft', priority: 78 },
  { crop: 'hyldeblomst', cropLabel: 'Hyldeblomst undervejs', path: '/assets/forvandlinger/crops/hyldeblomst/hyldeblomst-proces-01.jpg', role: 'kitchen', mood: 'quiet', seasons: ['summer'], useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'hyldeblomstsaft', priority: 74 },
  { crop: 'syren', cropLabel: 'Syren-is', path: '/assets/forvandlinger/crops/syren/syren-is-01.jpg', role: 'kitchen', mood: 'fresh', seasons: ['spring'], useCases: ['mosaic', 'recipeTile', 'forvandling'], forvandlingId: 'syren-is', priority: 86 },
