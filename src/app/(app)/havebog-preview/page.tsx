...
import {
  DEMO_INSPIRER, DEMO_ON_THIS_DAY, DEMO_PROJEKT, DEMO_PROJEKT_ILLUSTRATION,
  DEMO_PROJEKT_COLORFIELD, DEMO_POPULAERT,
...
export default function HavebogPreviewPage() {
  return (
    <div className="space-y-14 py-6">
      ...
      <div><Lbl>4A · Næste projekt — photo</Lbl><Projekter projekt={DEMO_PROJEKT} /></div>
      <div><Lbl>4B · Næste projekt — soft-illustration (default)</Lbl><Projekter projekt={DEMO_PROJEKT_ILLUSTRATION} /></div>
      <div><Lbl>4C · Næste projekt — color-field (fallback)</Lbl><Projekter projekt={DEMO_PROJEKT_COLORFIELD} /></div>
