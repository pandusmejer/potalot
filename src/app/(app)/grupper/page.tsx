    ...
    <div className="space-y-6 max-w-2xl">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Private grupper hvor du kan dele idéer med familie eller venner.
          </p>
        </div>
        <CreateGroupDialog />
      </div>
      ...
      {groups.length === 0 ? (
        <EmptyState
          ...
          description="Opret en gruppe for at dele idéer med familie eller venner. Du inviterer dem med via deres brugernavn."
        />
      ) : (
