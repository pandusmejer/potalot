      ...
      >
        {billede && (
          <>
            ...
            <div
              aria-hidden
              style={{ position: 'absolute', inset: 0, background: 'linear-gradient(90deg, #F4EEDC 0%, rgba(244,238,220,0.96) 42%, rgba(244,238,220,0.30) 70%, rgba(244,238,220,0) 100%)' }}
            />
          </>
        )}
        ...
        <div style={{ position: 'relative', padding: 22, maxWidth: '62%' }}>
          <p
            className="uppercase"
            style={{ fontFamily: sans, fontSize: 11, fontWeight: 700, letterSpacing: '0.22em', color: '#8F9484', margin: 0, marginBottom: 14, maxWidth: 160 }}
          >
            {forslag.kicker}
          </p>
          <p
          ...
          <p
            style={{ fontFamily: sans, fontSize: 14, fontWeight: 400, lineHeight: 1.5, color: '#45503F', margin: 0 }}
          >
            {forslag.tekst}
          </p>
          <Link
