 ...
 *
 * Anna (14. juni 2026): placeres som status-strimmel ØVERST, over hero-
 * fotoet. Ét varmt papir-panel, ikke fire bokse; ikonerne er sarte og
 * grå; tallene er stille. Skal læses som et måleinstrument på et havekort,
 * ikke som dashboard-metrics. Status og sundhed bærer et lille farve-
 * signal (grøn prik / hjerte).
 */
export function PlantMaal({ maal }: { maal: DetailMaal }) {
  ...
  return (
    <section
      className="relative flex items-stretch overflow-hidden rounded-[22px]"
      style={{
        background: 'var(--card)',
        border: '1px solid rgba(36,48,31,0.08)',
        boxShadow: '0 8px 22px rgba(26,34,22,0.08)',
        padding: '15px 6px',
      }}
    >
      {felter.map((f, i) => {
